...
public interface IExternalVideoInputService extends android.os.IInterface {
    boolean setExternalVideoInput(int type, android.content.Intent intent) throws android.os.RemoteException;

    /**
     * Default implementation for IExternalVideoInputService.
     */
    class Default implements IExternalVideoInputService {
     ...
     */
    abstract class Stub extends android.os.Binder implements IExternalVideoInputService {
