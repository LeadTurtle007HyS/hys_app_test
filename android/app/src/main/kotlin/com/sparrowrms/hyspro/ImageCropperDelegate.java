...
public class ImageCropperDelegate implements PluginRegistry.ActivityResultListener {
    ...
    public ImageCropperDelegate(Activity activity, CropResultListener cropResultListener) {
        ...
        if (pendingResult != null) {
          //  pendingResult.success(imagePath);
            if(cropResultListener!=null){
                cropResultListener.onCropSuccess(imagePath);
            }
            clearMethodCallAndResult();
        }
    }
    ...
    interface CropResultListener{
        void onCropSuccess(String fileUri);
        void onCropError();
    }
}
