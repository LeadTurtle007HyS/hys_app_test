...
import com.sparrowrms.hyspro.model.locators.SearchItemType
...
//            if(liveListViewType==ListViewType.FAILURE_VIEW || liveListViewType==ListViewType.EMPTY_VIEW){
//                if(searchCount<=2 && ::searchQuery.isInitialized){
//                  val subQuery=searchQuery.subSequence(0,searchQuery.length/2)
//                    search(this.spineSize, subQuery as String)
//                }else{
