...
public class HighlyRelatedBooksAdapter extends RecyclerView.Adapter<HighlyRelatedBooksAdapter.HighlightedBookListHolder> {
    ...
    public HighlyRelatedBooksAdapter(List<HighlyRelatedBooksModel> highlightedBookList, Context context,HighlyRelatedBooksAdapterCallback highlyRelatedBooksAdapterCallback) {
