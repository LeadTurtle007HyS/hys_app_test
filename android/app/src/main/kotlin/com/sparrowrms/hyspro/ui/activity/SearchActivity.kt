...
import com.sparrowrms.hyspro.ui.adapter.ListViewType
import com.sparrowrms.hyspro.ui.adapter.OnItemClickListener
import com.sparrowrms.hyspro.ui.adapter.SearchAdapter
import com.sparrowrms.hyspro.ui.view.FolioSearchView
import com.sparrowrms.hyspro.util.AppUtil
import com.sparrowrms.hyspro.util.UiUtil
import com.sparrowrms.hyspro.viewmodels.SearchViewModel
...
class SearchActivity : AppCompatActivity(), OnItemClickListener {
    ...
    companion object {
        ...
        const val BUNDLE_IS_SEARCH_SUBMIT="BUNDLE_IS_SEARCH_SUBMIT"
    }
    ...
    private fun handleSearch() {
        ...
        query?.let {
            searchViewModel.search(spineSize, it)
        }
    }
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        if (savedInstanceState != null) {
            ...
            if (!TextUtils.isEmpty(searchQuery)) {
                searchView.setQuery(searchQuery, intent.getBooleanExtra(BUNDLE_IS_SEARCH_SUBMIT,false))
                AppUtil.hideKeyboard(this)
