...
// class SocialFeedImagesComments extends StatefulWidget {
//   String feedID;

//   int imgIndex;
//   SocialFeedImagesComments(this.feedID, this.imgIndex);
//   @override
//   _SocialFeedImagesCommentsState createState() =>
//       _SocialFeedImagesCommentsState(this.feedID, this.imgIndex);
// }

// class _SocialFeedImagesCommentsState extends State<SocialFeedImagesComments> {
//   String feedID;
//   int imgIndex;
//   _SocialFeedImagesCommentsState(this.feedID, this.imgIndex);
...
//                               imageUrl: personaldata.docs[0].get("profilepic"),
//                               fit: BoxFit.cover,
...
//                                 1
//                           });
//                           _notificationdb.socialFeedCommentNotificationsImages(
//                               personaldata.docs[0].get("firstname") +
//                                   personaldata.docs[0].get("lastname"),
//                               personaldata.docs[0].get("profilepic"),
...
//   _socialFeed(int i) {
//     List tagedusername = socialfeed.docs[feedindex].get("tagedimagename");
//     List tageduserid = socialfeed.docs[feedindex].get("tagedimageid");
...
//                           ),
//                         ),
//                         int.parse(countData2.child(smComments.docs[i].id).child(
...
//                             ? Text(
//                                 " " +
//                                     (countData2.child(smComments.docs[i].id).child(
//                                             "commentcount")).value.
//                                         toString() +
//                                     " ",
//                                 style: TextStyle(
...
//                                 )
//                               : SizedBox(),
//                           int.parse(countData3.child(smReplies.docs[subcommentIndex].id).child(
