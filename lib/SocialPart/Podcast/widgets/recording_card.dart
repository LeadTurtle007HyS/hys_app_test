...
class RecordingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<AudioPlayerController>(
      create: (_) => AudioPlayerController("https://firebasestorage.googleapis.com/v0/b/hys-pro-41c66.appspot.com/o/podcast_bg_music%2Femotional-piano-sad-background-music-for-videos-5688.mp3?alt=media&token=16d64e15-a2e6-4029-b7ee-911444fe7536"),
      child: Card(
        elevation: 10,
        color: Colors.white,
            ...
            children: [
              ListTile(
                onTap: () async {
                  ...
                  if (apc.audioPlayer.playing &&apc.audioPlayer.processingState != ProcessingState.completed) {
                    apc.stop();
                  } else {
                    await apc.setSource("https://firebasestorage.googleapis.com/v0/b/hys-pro-41c66.appspot.com/o/podcast_bg_music%2Femotional-piano-sad-background-music-for-videos-5688.mp3?alt=media&token=16d64e15-a2e6-4029-b7ee-911444fe7536");
                    apc.play();
                  }
                },
