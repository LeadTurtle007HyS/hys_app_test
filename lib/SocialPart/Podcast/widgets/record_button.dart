...
import 'package:hys/SocialPart/Podcast/painters/ripple_painter.dart';
...
class _RecordButtonState extends State<RecordButton>
  ...
  Future<void> _startRecording(Function() action) async {
    ...
    final PathController pathController = Provider.of<PathController>(context, listen: false);
